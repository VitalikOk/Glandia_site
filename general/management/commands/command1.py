...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        all_members_sheets, all_members = get_all_values_sheets(CLUB_CP_MEMBERS_SHEET, gspread.service_account(filename='general/conf/gs.json'))    
        # print(all_members[2])
        ...
        class Users(models.Model):
            ...
            expire = models.DateField(verbose_name="дата истечения", null=True)
        ...
        # ['Дата вступления', 'Имя Фамилия', 'Номер телефона', 'Email',             'Примечания', 'QR-код отправлен', 'Свои', 'Срок действия', 'Надо печатать', 'Номер карты ВВ']
        # ['2022-01-10',      'Катерина ',     '9650245068', 'kat833666@yandex.ru', '',           'ДА',               '',       '12.2022',      '',             'D011934']
